  ...
  <div class="banner-section section mb-30 mt-30">
    <div class="container">
      <div class="row row-10">

        <!-- Banner -->
        <div class="col-md-8 col-12 mb-30">
          <div class="banner"><a href="#"><img src="<?=base_url('images/home/'.$home['770x320'])?>" alt="Banner"></a></div>
        </div>

        <!-- Banner -->
        <div class="col-md-4 col-12 mb-30">
          <div class="banner"><a href="#"><img src="<?=base_url('images/home/'.$home['380x320'])?>" alt="Banner"></a></div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 mb-40">
          <div class="section-title-one" data-title="FEATURED ITEMS">
  ...
  <div class="product-section section mb-60">
    <div class="container">
      <div class="row">
        ...
        <!-- Section Title Start -->
        <div class="col-12 mb-40">
          <div class="section-title-one" data-title="NEW ARRIVAL">
            <h1>NEW ARRIVAL</h1>
          </div>
        </div><!-- Section Title End -->
